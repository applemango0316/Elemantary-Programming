...
def weather():
    ...
    weather_origin = open("weather_origin.txt", "w", encoding="UTF-8")
    weather_origin.write(text)
    weather_origin.close()
    ...
    if CD == "맑음":
        weather_warning = "오늘은 맑은 날씨로 외출하기 좋은 날입니다. 썬크림을 잘 챙겨 바르시고 외출하세요."
    else:
        if CD == "소나기":
            weather_warning = "비가 내릴 수 있으니 우산을 챙겨 나가세요."
        if CD == "가끔 비":
            weather_warning = "비가 내릴 수 있으니 우산을 챙겨 나가세요."
        if CD == "한때 비":
            weather_warning = "비가 내릴 수 있으니 우산을 챙겨 나가세요."
            ...
            if CD == "비":
                weather_warning = "비가 내리고 있으니 우산을 챙겨 나가세요."
            else:
                if CD == "가끔 눈":
                    weather_warning = "눈이 내릴 수 있으니 옷을 두껍게 입으시고 우산을 챙겨 나가세요."
                if CD == "한때 눈":
                    weather_warning = "한때 눈이 내릴 수 있으니 옷을 두껍게 입으시고 우산을 챙겨 나가세요."
                else:
                    if CD == "눈":
                        weather_warning = "눈이 내리고 있으니 옷을 두껍게 입으시고 우산을 챙겨 나가세요."
                    else:
                        if CD == "가끔 비 또는 눈":
                            weather_warning = "비나 눈이 내릴 수 있으니 우산을 챙겨 나가세요."
                        if CD == "한때 비 또는 눈":
                            weather_warning = "비나 눈이 내릴 수 있으니 우산을 챙겨 나가세요."
                        if CD == "가끔 눈 또는 비":
                            weather_warning = "비나 눈이 내릴 수 있으니 우산을 챙겨 나가세요."
                        if CD == "한때 눈 또는 비":
                            ...
                            if CD == "비 또는 눈" or "눈 또는 비":
                                weather_warning = "비나 눈이 내리고 있으니 우산을 챙겨 나가세요."
                            if CD == "눈 또는 비":
                                weather_warning = "비나 눈이 내리고 있으니 우산을 챙겨 나가세요."
                            else:
                                if CD == "천둥번개":
                                    weather_warning = "천둥번개가 치고있으니 외출을 최대한 자제하시고 우산을 챙겨 나가세요."
                                else:
                                    if CD == "연무":
                                        weather_warning = "시야 확보가 어려우니 운전시 주의하세요"
                                    if CD == "박무":
                                        weather_warning = "시야 확보가 어려우니 운전시 주의하세요."
                                    if CD == "안개":
                                        weather_warning = "시야 확보가 어려우니 운전시 주의하세요."
...
while loop < 12:
    ...
    loop = loop + 1
    line_loop = 0
    WF = open("weather_record.txt", "w", encoding="UTF-8")
